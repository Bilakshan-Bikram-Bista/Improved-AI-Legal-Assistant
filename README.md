...
A natural-language search engine for Nepali law. Ask a legal question in plain English (or Nepali) and get back the actual, cited section of the law that answers it — no guessing, no black box.
...
### Evaluation
This system was formally evaluated against a hand-labeled query set and benchmarked against both a TF-IDF baseline and Gemini. Full methodology and results are documented in the accompanying research paper, [*AI Legal Assistant for Ethical AI and Algorithmic Accountability*].
